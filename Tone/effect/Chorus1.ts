...
export class Chorus1 extends FeedbackEffect<Chorus1Options> {
	 ...
	 */
	constructor(channel?: number, frequency?: Frequency, delayTime?: Milliseconds, depth?: NormalRange);
	constructor(options?: Partial<Chorus1Options>);
	constructor() {

		super(optionsFromArguments(Chorus1.getDefaults(), arguments, ["channel", "frequency", "delayTime", "depth"]));
		const options = optionsFromArguments(Chorus1.getDefaults(), arguments, ["channel", "frequency", "delayTime", "depth"]);
